...
public enum CountriesCodes {
    ...
    AMERICAN_SAMOA ("American Samoa", "1-684", "AS"),
    ANDORRA ("Andorra", "376", "AD"),
    ANGOLA ("Angola", "244", "AO"),
    ANGUILLA ("Anguilla", "1-264", "AI"),
    ANTARCTICA ("Antarctica", "672", "AQ"),
    ANTIGUA_AND_BARBUDA ("Antigua and Barbuda", "1-268", "AG"),
    ...
    BRITISH_VIRGIN_ISLANDS ("British Virgin Islands", "1-284", "VG"),
    ...
    CUBA ("Cuba", "53", "CU"),
    CURACAO ("Curacao", "599", "CW"),
    CYPRUS ("Cyprus", "357", "CY"),
    CZECH_REPUBLIC ("Czech Republic", "420", "CZ"),
    DEMOCRATIC_REPUBLIC_OF_THE_CONGO ("Democratic Republic of the Congo", "243", "CD"),
    DENMARK ("Denmark", "45", "DK"),
    DJIBOUTI ("Djibouti", "253", "DJ"),
    DOMINICA ("Dominica", "1-767", "DM"),
    DOMINICAN_REPUBLIC ("Dominican Republic", "1-809, 1-829, 1-849", "DO"),
    EAST_TIMOR ("East Timor", "670", "TL"),
    ...
    GRENADA ("Grenada", "1-473", "GD"),
    GUAM ("Guam", "1-671", "GU"),
    GUATEMALA ("Guatemala", "502", "GT"),
    GUERNSEY ("Guernsey", "44-1481", "GG"),
    ...
    ISLE_OF_MAN ("Isle of Man", "44-1624", "IM"),
    ISRAEL ("Israel", "972", "IL"),
    ITALY ("Italy", "39", "IT"),
    IVORY_COAST ("Ivory Coast", "225", "CI"),
    JAMAICA ("Jamaica", "1-876", "JM"),
    JAPAN ("Japan", "81", "JP"),
    JERSEY ("Jersey", "44-1534", "JE"),
    ...
    MONTSERRAT ("Montserrat", "1-664", "MS"),
    ...
    NORTHERN_MARIANA_ISLANDS ("Northern Mariana Islands", "1-670", "MP"),
    NORWAY ("Norway", "47", "NO"),
    OMAN ("Oman", "968", "OM"),
    PAKISTAN ("Pakistan", "92", "PK"),
    PALAU ("Palau", "680", "PW"),
    PALESTINE ("Palestine", "970", "PS"),
    PANAMA ("Panama", "507", "PA"),
    PAPUA_NEW_GUINEA ("Papua New Guinea", "675", "PG"),
    PARAGUAY ("Paraguay", "595", "PY"),
    PERU ("Peru", "51", "PE"),
    PHILIPPINES ("Philippines", "63", "PH"),
    PITCAIRN ("Pitcairn", "64", "PN"),
    POLAND ("Poland", "48", "PL"),
    PORTUGAL ("Portugal", "351", "PT"),
    PUERTO_RICO ("Puerto Rico", "1-787, 1-939", "PR"),
    QATAR ("Qatar", "974", "QA"),
    REPUBLIC_OF_THE_CONGO ("Republic of the Congo", "242", "CG"),
    ...
    SAINT_KITTS_AND_NEVIS ("Saint Kitts and Nevis", "1-869", "KN"),
    SAINT_LUCIA ("Saint Lucia", "1-758", "LC"),
    SAINT_MARTIN ("Saint Martin", "590", "MF"),
    SAINT_PIERRE_AND_MIQUELON ("Saint Pierre and Miquelon", "508", "PM"),
    SAINT_VINCENT_AND_THE_GRENADINES ("Saint Vincent and the Grenadines", "1-784", "VC"),
    SAMOA ("Samoa", "685", "WS"),
    ...
    SINT_MAARTEN ("Sint Maarten", "1-721", "SX"),
    ...
    TONGA ("Tonga", "676", "TO"),
    TRINIDAD_AND_TOBAGO ("Trinidad and Tobago", "1-868", "TT"),
    TUNISIA ("Tunisia", "216", "TN"),
    TURKEY ("Turkey", "90", "TR"),
    TURKMENISTAN ("Turkmenistan", "993", "TM"),
    TURKS_AND_CAICOS_ISLANDS ("Turks and Caicos Islands", "1-649", "TC"),
    TUVALU ("Tuvalu", "688", "TV"),
	US_VIRGIN_ISLANDS ("U.S. Virgin Islands", "1-340", "VI"),
    ...
    CountriesCodes(String countryName, String NMCode, String countryIso) {
        this.countryName = countryName;
        this.NMCode = NMCode;
        this.countryIso = countryIso;
    }

    public static CountriesCodes getObject(String str) {
